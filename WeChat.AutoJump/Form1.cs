...
namespace WeChat.AutoJump
{
    public partial class Form1 : Form
    {
        ...
        {
            var sourceImg = this.ActionSvc.GetScreenshots();
            mainPicBox.Image = sourceImg;

            this.Model.Image = new WidthHeight() { Width = sourceImg.Width, Height = sourceImg.Height };

            Image<Gray, Byte> img = new Image<Gray, byte>(sourceImg);
            ...
            this.txtMsg.Text = this.Model.ToString();
        }

        private void button1_Click(object sender, EventArgs e)
        {
            this.ActionSvc.Action(this.Model.Time);
        }
    }
}
